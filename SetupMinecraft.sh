...
# curl https://raw.githubusercontent.com/mastershakej/MinecraftBedrockServer/CustomDir/SetupMinecraft.sh | bash
#
# GitHub Repository: https://github.com/mastershakej/MinecraftBedrockServer

echo "Minecraft Bedrock Server installation script by James A. Chambers"
echo "Latest version always at https://github.com/mastershakej/MinecraftBedrockServer"
...
function read_with_prompt {
  ...
  while [[ ! -n ${!variable_name} ]]; do
    ...
    declare -g $variable_name=$(echo "${!variable_name}" | head -n1 | awk '{print $1;}' | tr -cd '[a-zA-Z0-9]')
...
Update_Scripts() {
  ...
  curl -H "Accept-Encoding: identity" -L -o start.sh https://raw.githubusercontent.com/mastershakej/MinecraftBedrockServer/CustomDir/start.sh
  chmod +x start.sh
  ...
  curl -H "Accept-Encoding: identity" -L -o stop.sh https://raw.githubusercontent.com/mastershakej/MinecraftBedrockServer/CustomDir/stop.sh
  chmod +x stop.sh
  ...
  curl -H "Accept-Encoding: identity" -L -o restart.sh https://raw.githubusercontent.com/mastershakej/MinecraftBedrockServer/CustomDir/restart.sh
  chmod +x restart.sh
  ...
  curl -H "Accept-Encoding: identity" -L -o fixpermissions.sh https://raw.githubusercontent.com/mastershakej/MinecraftBedrockServer/CustomDir/fixpermissions.sh
  ...
  curl -H "Accept-Encoding: identity" -L -o revert.sh https://raw.githubusercontent.com/mastershakej/MinecraftBedrockServer/CustomDir/revert.sh
  chmod +x revert.sh
  ...
  curl -H "Accept-Encoding: identity" -L -o update.sh https://raw.githubusercontent.com/mastershakej/MinecraftBedrockServer/CustomDir/update.sh
  chmod +x update.sh
...
Update_Service() {
  ...
  sudo curl -H "Accept-Encoding: identity" -L -o /etc/systemd/system/$ServerName.service https://raw.githubusercontent.com/mastershakej/MinecraftBedrockServer/CustomDir/minecraftbe.service
...
Check_Architecture() {
  ...
  if [[ "$CPUArch" == *"aarch"* ]]; then
    ...
    curl -H "Accept-Encoding: identity" -L -o depends.zip https://raw.githubusercontent.com/mastershakej/MinecraftBedrockServer/CustomDir/depends.zip
    unzip depends.zip
    sudo mkdir /lib64
